...
function useDiagramsNet(onSaveCallback, onStopEditing, getName, getData) {
  const [save1, setSave1] = (0, import_react.useState)(null);
  const [save2, setSave2] = (0, import_react.useState)(null);
  ...
  function startEditing() {
    ...
    let frame = /* @__PURE__ */ import_react.default.createElement("iframe", {
      src: url,
      id: frameId,
      title: frameId,
      ref: frameRef,
    ...
    import_react_dom.default.render(frame, document.getElementById(frameId));
  }
  function stopEditing() {
    onStopEditing();
    try {
      import_react_dom.default.render(/* @__PURE__ */ import_react.default.createElement("div", {
        id: frameId
...
var useDiagramsNet_default = useDiagramsNet;

// src/DiagramsApp.tsx
var DiagramsApp = (props) => {
  const {
    xmlPath,
    diagramExists,
    vault,
  ...
  const [xmlData, setXmlData] = React2.useState(null);
  const { startEditing } = useDiagramsNet_default(handleSaveAndExit, handleExit, () => "", () => xmlData);
  const loadXmlData = () => __async(void 0, null, function* () {
    const xmlFile = vault.getAbstractFileByPath(xmlPath);
    const data = yield vault.cachedRead(xmlFile);
    setXmlData(data);
  });
  React2.useEffect(() => {
    if (diagramExists) {
...
var DiagramsView = class extends import_obsidian.ItemView {
  getDisplayText() {
    var _a;
  ...
  constructor(leaf, hostView, initialFileInfo) {
    super(leaf);
  ...
  onOpen() {
    return __async(this, null, function* () {
      ...
      ReactDOM2.render(/* @__PURE__ */ React3.createElement(DiagramsApp, {
  ...
  onClose() {
    return __async(this, null, function* () {
      ReactDOM2.unmountComponentAtNode(this.containerEl.children[1]);
    });
  }
};
...
var DiagramsNet = class extends import_obsidian2.Plugin {
  onload() {
    return __async(this, null, function* () {
      ...
      this.registerView(DIAGRAM_VIEW_TYPE, (leaf) => this.diagramsView = new DiagramsView(leaf, null, {
  ...
  availablePath() {
    return __async(this, null, function* () {
      const base = yield this.vault.getAvailablePathForAttachments("Diagram", "svg");
      return {
        svgPath: base,
  ...
  handleEditorMenu(menu, editor, view) {
    menu.addItem((item) => {
      item.setTitle("Insert new diagram").setIcon("diagram").onClick(() => __async(this, null, function* () {
        this.attemptNewDiagram();
      }));
    });
  }
